...
The bundled HLA protein alignment used in the amino acid analysis can be updated to the most recent release (https://www.ebi.ac.uk/ipd/imgt/hla). 'BIGDAWG v1.1' was bundled using IMGT/HLA database release 3.20.0, 2015-04-17. Future databse updates do not guarantee compatability with the updating tool.

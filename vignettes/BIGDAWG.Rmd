...
* HLA/IMGT Database Release 3.38.0, 2019-10-17
...
For the amino acid analysis, BIGDAWG is bundled with HLA protein alignment data using theabove  indicated database release. These bundled alignments can be updated to the most recent release [IPD-IMGT/HLA](https://www.ebi.ac.uk/ipd/imgt/hla/). Future database updates do not guarantee compatibility with the updating tool.
